...
@section('title', 'Category Skincare')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Category Skincare</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.index.category')}}">Home</a></li>
                        <li class="breadcrumb-item active">Data Category Skincare</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header justify-content-between" style="display: flex">
                            <a href="{{ route('admin.form.category') }}" class="btn btn-primary btn-md">Add Category
                                Skincare</a>
