        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome, {{Auth::User()->last_name }}</h3>
                    <h6 class="font-weight-normal mb-0">Welcome to {{ Auth::user()->first_name }}'s page.
                ...
                <div class="card-people mt-auto">
                    ...
                    <div class="weather-info">
                        <div class="d-flex">
                            ...
                            <div class="ml-2">
                                <h4 class="location font-weight-normal">Jilin</h4>
                                <h6 class="font-weight-normal">China</h6>
                            </div>
                        </div>
                    </div>
                </div>
